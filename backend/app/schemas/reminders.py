...
``ReminderRunSummary``
    ...
    All fields are present from their respective steps onward to keep the
    schema stable:
    - ``low_stock`` is always 0 in Step 3; Step 4 fills it.
    - ``maintenance`` is always 0 before M7 Step 5; Step 5 fills it.
"""
